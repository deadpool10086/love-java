...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("<h1>题目</h1>\r\n");
      out.write("<div class=\"\">\r\n");
      out.write("题目描述：小明知道了后台地址可没有用户名与密码怎么办呢？老板又天天催他，眼看工作就要没了，你能帮助他吗？\r\n");
      out.write("<br/>\r\n");
      out.write("<br/>\r\n");
      out.write("题目地址<a href=\"http://icctf.oicp.net:1234/web1/login/\">icctf.oicp.net:1234/web1/login/</a>\r\n");
      out.write("提交形式：flag：{xxx} 只要提交xxx\r\n");
      out.write("<div>\r\n");
      out.write(" ");
      ...
      out.write("\t\t <form action=\"thirdAction.action\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\tflag:<input type=\"text\" name=\"key3\" ><br/>\r\n");
      out.write("\t\t\t\t\t\t\t&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\r\n");
