...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("<h1>题目</h1>\r\n");
      out.write("<div class=\"\">\r\n");
      out.write("题目描述：这里什么都没有，猜猜flag藏在哪里呢？\r\n");
      out.write("<br/>\r\n");
      out.write("<br/>\r\n");
      out.write("题目地址<a href=\"http://192.168.239.158:12345/\">192.168.239.158:12345</a>\r\n");
      out.write("提交形式：flag：{xxx} 只需提交xxx\r\n");
      out.write("<div>\r\n");
      out.write(" ");
      ...
      out.write("\t\t <form action=\"firstAction.action\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\tflag:<input type=\"text\" name=\"key1\" ><br/>\r\n");
      out.write("\t\t\t\t\t\t\t&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\r\n");
